...
export class MatiereListEffects {
  ...
  @Effect() LoadMatieres$: Observable<
    MatiereListModule.Actions
  > = this.actions$.pipe(
  ...
  @Effect() LoadCreateMatiere$: Observable<
    MatiereListModule.Actions
  > = this.actions$.pipe(
    ofType<MatiereListModule.LoadCreateMatiere>(
      MatiereListModule.ActionTypes.LOAD_CREATE_MATIERE
    ),
  ...
  @Effect() LoadDeleteMatiere$: Observable<
    MatiereListModule.Actions
  > = this.actions$.pipe(
    ofType<MatiereListModule.LoadDeleteMatiere>(
      MatiereListModule.ActionTypes.LOAD_DELETE_MATIERE
    ),
